...
with drawer:
    ...
    ui.link('חיפוש', '#').classes('block mb-2 text-[#4a3c2a]')
...
for i in range(10):
    with ui.row().classes('w-full items-center, justify-center'):
        with ui.card().classes('w-96 bg-[#ffffff] shadow-md p-4 rounded-xl'):
            ...
            ui.image("https://tekoafarms.co.il/wp-content/uploads/2024/10/5-1-860x643.jpg").classes('w-full object-contain rounded-lg mb-3')
